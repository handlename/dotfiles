...
プロジェクトのタスク実行において、TASKS.md、REQUIREMENTS.md、DESIGN.mdファイルに基づく体系的な作業進行が必要である。
...
- TASKS.mdから指定されたタスクの詳細を読み取り理解する
...
- 必要なドキュメント(TASKS.md、REQUIREMENTS.md、DESIGN.md)が存在しない場合
